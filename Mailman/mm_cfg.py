...
DEFAULT_URL_HOST   = 'www.iris.washington.edu'
DEFAULT_EMAIL_HOST = 'iris.washington.edu'
...
# Show the same mailing lists regardless of the actual host name used
# This shouldn't be necessary; all lists should have the proper host name
VIRTUAL_HOST_OVERVIEW = Off

# Image logos are on the main IRIS webserver
